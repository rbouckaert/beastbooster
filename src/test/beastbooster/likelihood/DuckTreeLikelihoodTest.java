...
import beastbooster.likelihood.DuckTreeLikelihood;
 ...
 * *
 */
public class DuckTreeLikelihoodTest extends TestCase {

    public DuckTreeLikelihoodTest() {
        super();
    }

    protected GenericTreeLikelihood newTreeLikelihood() {
    	System.setProperty("java.only","true");
        return new DuckTreeLikelihood();
    }
    ...
    public void testJC69Likelihood() throws Exception {
    	for (int i = 6; i < 11; i++) {
	        ...
	        ((Targetable)likelihood).setTarget(i);
	        double logP = 0;
	        logP = likelihood.calculateLogP();
	        assertEquals(-1992.2056440317247, logP, BEASTTestCase.PRECISION);
    ...
    public void testJC69LikelihoodWithUncertainCharacters() throws Exception {
    	for (int i = 3; i < 5; i++) {
	    	...
	    	logL = testJC69Likelihood(data,tree, i);
	    	logL_uncertain = testJC69Likelihood(data2,tree, i);
	    	...
	    	logL_uncertain = testJC69Likelihood(data3,tree, i);
	    	assertEquals(logL_uncertain[0], 2 * x3, BEASTTestCase.PRECISION);    	
	    	assertEquals(logL_uncertain[1], 2 * x4, BEASTTestCase.PRECISION);
    	}    	
    }        
    
    public double[] testJC69Likelihood(Alignment data, Tree tree, int target) throws Exception {
        // Set up JC69 model: uniform freqs, kappa = 1, 0 gamma categories                              
        JukesCantor JC = new JukesCantor();
        JC.initAndValidate();
        ...
        ((Targetable) likelihood).setTarget(target);
    ...
    public void testAscertainedJC69Likelihood() throws Exception {
    	...
    	for (int i = 6; i < 11; i++) {
	        ...
	        assertEquals(-737.7140695360017, logP, BEASTTestCase.PRECISION);
    	}
    }
    ...
    public void testK80Likelihood() throws Exception {
    	...
    	for (int i = 6; i < 11; i++) {
	        ...
	        double logP = 0;
	        logP = likelihood.calculateLogP();
	        assertEquals(-1856.303048876734, logP, BEASTTestCase.PRECISION);
    ...
    public void testHKY85Likelihood() throws Exception {
    	...
    	for (int i = 6; i < 11; i++) {
	        ...
	        double logP = 0;
	        logP = likelihood.calculateLogP();
	        assertEquals(-1825.2131708068507, logP, BEASTTestCase.PRECISION);
    ...
    public void testHKY85GLikelihood() throws Exception {
    	...
    	for (int i = 6; i < 11; i++) {
	        ...
	        assertEquals(-1789.7593576610134, logP, BEASTTestCase.PRECISION);
    ...
    public void testHKY85ILikelihood() throws Exception {
        ...
        double logP = 0;
        logP = likelihood.calculateLogP();
        assertEquals(-1789.912401996943, logP, BEASTTestCase.PRECISION);
    ...
    public void testHKY85GILikelihood() throws Exception {
        ...
        double logP = 0;
        logP = likelihood.calculateLogP();
        assertEquals(-1789.639227747059, logP, BEASTTestCase.PRECISION);
    ...
    public void testGTRLikelihood() throws Exception {
        ...
        double logP = 0;
        logP = likelihood.calculateLogP();
        assertEquals(-1969.145839307625, logP, BEASTTestCase.PRECISION);
    ...
    public void testGTRILikelihood() throws Exception {
        ...
        double logP = 0;
        logP = likelihood.calculateLogP();
        assertEquals(-1948.8417455357564, logP, BEASTTestCase.PRECISION);
    ...
    public void testGTRGLikelihood() throws Exception {
        ...
        double logP = 0;
        logP = likelihood.calculateLogP();
        assertEquals(-1949.0360143622, logP, BEASTTestCase.PRECISION);
    ...
    public void testGTRGILikelihood() throws Exception {
        ...
        double logP = 0;
        logP = likelihood.calculateLogP();
        assertEquals(-1947.5829396144961, logP, BEASTTestCase.PRECISION);
...
//
//        DuckTreeLikelihood likelihood = newTreeLikelihood();
//        likelihood.initByName("data", data, "tree", tree, "siteModel", siteModel);
//
//        double logP = 0;
...
//        assertEquals(-3551.6436270344648, logP, BEASTTestCase.PRECISION);
//    }
//
//
//    @Test
...
//        assertEquals(-1730.53631739, logP, BEASTTestCase.PRECISION);
//    }
//
//    
//    
...
//
//        DuckTreeLikelihood likelihoodNoBeagle = newTreeLikelihood();
//
...
//        DuckTreeLikelihood likelihoodBeagle = new DuckTreeLikelihood();
